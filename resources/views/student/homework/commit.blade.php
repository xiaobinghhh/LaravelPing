...
<div class="container" z-index="-1">
    ...
    <div class="row" style="padding: 10px">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form action="{{url("student/course/".$course->no."/homework/".$homework->homework_id."/commit")}}"
                  method="post"
                  id="form_homework_commit"
