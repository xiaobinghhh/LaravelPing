...
<div class="container" z-index="-1">
    <div class="row" style="padding: 10px">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 10px">
            <a type="button" class="btn btn-default" href="{{url('course/'.$course->no.'/report_ping')}}"><span
...
<!-- 图表容器 DOM -->
    ...
    <script>
        ...
        $.ajax({
            ...
            url: '{{url('course/'.$course->no.'/report_chart_data')}}',
            success: function (data) {
                ...
                new Highcharts.Chart({
                    ...
                    title: {
                        text: '\"{{$course->name}}\" 各次报告完成统计'   //图表标题
                    },
                    xAxis: {                            //X轴标签
                        categories: category
                    },
