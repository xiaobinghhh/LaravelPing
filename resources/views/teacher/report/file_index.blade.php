            ...
            <div class="pull-left" style="padding-top: 10px">
                <ul class="breadcrumb">
                    @foreach ($breadcrumbs as $path => $disp)
                        <li><a href="{{url('course/'.$course->no.'/report_file?folder='.$path)}}">{{ $disp }}</a>
                        </li>
                    @endforeach
        ...
        <div class="col-sm-12">
            ...
            <table id="uploads-table" class="table table-striped table-bordered" data-undefined-text="-"
                ...
                @foreach ($subfolders as $path => $name)
                    <tr>
                        <td>
                            <a href="{{url('course/'.$course->no.'/report_file?folder='.$path)}}">
...
<div class="modal fade" id="modal-folder-create">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="POST" action="{{url('course/'.$course->no.'/report/upload/folder')}}"
...
<div class="modal fade" id="modal-file-delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="POST" action="{{url('course/'.$course->no.'/report/upload/file')}}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
